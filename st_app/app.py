...
# google search tool
search = GoogleSearchAPIWrapper(k=2, google_api_key=GOOGLE_CSE_API_KEY, google_cse_id=GOOGLE_CSE_ID)
tool = Tool(
    name="google_search",
...
def get_agent() -> AgentExecutor:
    llm = AzureChatOpenAI(temperature=0.0, model='gpt-4o-mini', api_version='2024-10-21', azure_endpoint=AZURE_OPENAI_ENDPOINT, api_key=AZURE_OPENAI_API_KEY)
